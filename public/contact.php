...
<main class="container">
  ...
  <div class="contact-section mt-5">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-info-section">
                            <div class="contact-information">
                                <h5 class="wrapper-heading mb-2">Contact Information</h5>
                                <p class="paragraph mb-2">Contact us via mobile, email, or by filling out the form .We will
                                    contact you as
                                    soon as possible.</p>
                                        ...
                                        <div class="col-sm-6 ">
                                            <div class="wrapper phone">
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <p class="paragraph">
                                                      <a class="hover:underline" href="tel:<?= htmlspecialchars($siteLevelsettings['contact_no'] ?? '99999 99999') ?>"><?= htmlspecialchars($siteLevelsettings['contact_no'] ?? '99999 99999') ?></a>,
                                                      <a href="tel:916381451509"> 90038 04877</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="wrapper phone">
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <a class="hover:underline" href="mailto:<?= htmlspecialchars($siteLevelsettings['contact_email'] ?? 'info@example.com') ?>"><?= htmlspecialchars($siteLevelsettings['contact_email'] ?? 'info@example.com') ?></a>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="address">
                                                ...
                                                <div class="contact-map">
                                                    ...
                                                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15552.60318379483!2d80.190226!3d12.9622009!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525d4b9d9d45ad%3A0xe5316e82bf18efb8!2sSirpika%20Millets!5e0!3m2!1sen!2sin!4v1721112317958!5m2!1sen!2sin" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        ...
        <form method="post" class="bg-white rounded">
           <h5 class="wrapper-heading mb-4">Enquiry</h5>

          <div class="mb-4">
            <input type="text" placeholder="Name" name="name" required class="w-full border p-2 rounded" />
          </div>
          <div class="mb-4">
          ...
          <button type="submit" class="bg-primary text-white text-uppercase font-bold px-4 py-3 rounded w-full mt-2">
            Submit
          </button>
        </form>
      </div>
