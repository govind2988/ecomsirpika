...
<head>
    ...
    <link href="vendor/owlcarousel-2.3.4/css/owl.carousel.min.css" rel="stylesheet" />
    <link href="vendor/owlcarousel-2.3.4/css/owl.theme.default.min.css" rel="stylesheet" />
    <link href="vendor/wow-4.1.1/css/animate.min.css" rel="stylesheet" />
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $message_status = '<div class="message error">Invalid email format</div>';
    } else {
        $to = "sirpikamillets@gmail.com";  // Replace with your email address
        $subject = "Sirpika Website | New Enquiry from $name";
        $curdate = date('d-m-Y');
...
<body>
    <div class='main'>
        <div class='container'>
            <div class='header'>
                <h1>Sirpika Millets | New Contact Form Submission</h1>
            </div>
            <div class='content'>
                <h2>Hi Team <span class='cdate'> $curdate </span></h2>
                <p>You have received a new inquiry from $name with the following details. Please check and contact them
                    immediately.</p>

                <p><strong class='label'>Name:</strong> $name</p>
                <p><strong class='label'>Email:</strong> $email</p>
                <p><strong class='label'>Phone:</strong> $phone</p>
                <p><strong class='label'>Message:</strong> $message </p>
            </div>
            <div class='footer'>
                <p>© 2024 Sirpika Millets. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</body>
        ...
        if (mail($to, $subject, $body, $headers)) {
            $message_status = '<div id="suc_message"  class="message success">Thank you for contacting us, ' . $name . '. We will get back to you shortly.</div>';
        } else {
            $message_status = '<div id="suc_message"  class="message error">Sorry, there was an error sending your message. Please try again later.</div>';
        }
    }
}
?>
    ...
    <header class="header">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <nav class="navbar navbar-expand-lg" aria-label="Fifth navbar example">
                    <div class="container-fluid p-0">
                        ...
                        <h1 class="mobile_logo text-center position-absolute start-0 container-fluid">
                            <a href="index.php"> <img src="assets/images/logo.svg" /></a>
                        </h1>

                        <ul class="nav deskMenu">
                            <li class="nav-item ">
                ...
                <div class="text-center whatsappChat">
                    <a href="tel:+6381451509">
                        <img src="assets/images/whatsapp.svg" /> <span>6381451509</span></a>
            ...
            <h1 class="logo text-center position-absolute start-0 container-fluid">
                <a href="index.php"> <img src="assets/images/logo.svg" /></a>
            </h1>
        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-info-section">
                            <div class="contact-information">
                                ...
                                <p class="paragraph">Contact us via mobile, email, or by filling out the form .We will
                                    contact you as
                                    soon as possible.</p>
                                        ...
                                        <div class="col-sm-6 ">
                                            <div class="wrapper phone">
                                                    ...
                                                    <span>
                                                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#1ABC9C" stroke="#1ABC9C"></path>
                                                            <path
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <p class="paragraph"><a href="tel:916381451509"> 63814 51509 </a>,
                                                        <a href="tel:916381451509">
                                                            90038 04877</a>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="wrapper phone">
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <p class="paragraph"><a href="mailto:sirpikamillets@gmail.com">
                                                            sirpikamillets@gmail.com</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="address">
                                                <div class="contact-address">
                                                    ...
                                                    <div class="address-content">
                                                        ...
                                                        <p class="paragraph">No-28, Srinivas Flats, 6th Street, Iayyapa
                                                            nagar, Madipakkam,
                                                            Chennai-600091
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="contact-map">
                                                    ...
                                                    <iframe
                                                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15552.60318379483!2d80.190226!3d12.9622009!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525d4b9d9d45ad%3A0xe5316e82bf18efb8!2sSirpika%20Millets!5e0!3m2!1sen!2sin!4v1721112317958!5m2!1sen!2sin"
                            ...
                            <div class="review-form box-shadows">
                                ...
                                <form action="contactus.php" method="POST">
                                    <div class="review-form-text">
                                        <h5 class="wrapper-heading">Get In Touch</h5>
                                    </div>
    ...
    <footer class="footer text-center">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-start">&copy;
                    <script>
                    document.write(new Date().getFullYear())
                    </script> Sirpika Millets. All Right Reserved.
                </div>

                <div class="col-md-6">
                    <ul class="socialMedia">
                        <li><a href="https://www.facebook.com/p/Sirpika-Millets-100067607876037/" target="_blank"><i
                                    class="fa-brands fa-facebook-f"></i></a></li>
                        <li><a href="https://www.instagram.com/sirpikamillets20/" target="_blank"><i
                                    class="fa-brands fa-instagram" target="_blank"></i></a></li>
                        <li><a href="https://www.youtube.com/@sirpikakitchen" target="_blank"><i
    ...
    <script src="vendor/owlcarousel-2.3.4/js/owl.carousel.min.js"></script>
    <script src="assets/js/custom.js"></script>
    <script src="vendor/wow-4.1.1/js/wow.min.js"></script>
</body>
