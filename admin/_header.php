...
<div class="flex flex-col text-gray-800 w-full">
    <header class="flex items-center h-16 px-6 fixed w-full z-10">
        <button
        ...
        <div class="flex flex-shrink-0 items-center ml-auto">
            <button class="inline-flex items-center focus:outline-none rounded-lg text-white">
                ...
                <span
                    class="h-12 w-12 flex items-center justify-center  text-white rounded-full overflow-hidden">
                    <!-- <img src="https://img.freepik.com/free-photo/african-woman-studio-white-wall-woman-white-shirt_1157-47613.jpg?size=626&ext=jpg&ga=GA1.2.516224105.1653748033"
            ...
            <div class="space-x-1">
                <a href="logout.php"
                    class="h-8 w-12 flex items-center justify-center relative text-white  border-l border-red-600 ">
